...
export const projects: Project[] = [
  {
    ...
    detailedDescriptionSv: "LiveNotes är en realtidsbaserad samarbetseditor för dokument byggd med Next.js 14 och Liveblocks. Den erbjuder en Google Docs-liknande upplevelse med funktioner för avancerad textredigering och realtidssamarbete i ett modernt, responsivt gränssnitt.",
    features: [
    ...
    solutionSv: "Byggd med Next.js 14, TypeScript och Tailwind CSS, använder LiveNotes Liveblocks för realtidssamarbete och Lexical för avancerad textredigering. Autentisering hanteras av Clerk, med UI-komponenter från Radix UI för tillgänglighet och konsistens.",
    ...
    outcomeSv: "Applikationen har optimerad prestanda med fördröjda sökningar, optimistiska UI-uppdateringar och progressiva förbättringstekniker. Serverkomponentarkitekturen i Next.js 14 ger utmärkt prestanda samtidigt som den upprätthåller en bra utvecklarupplevelse. Detta projekt visar avancerade kunskaper inom frontend-utveckling, inklusive realtidsdatasynkronisering, komplex tillståndshantering och responsiva UI-designprinciper.",
  ...
  },
  {
    ...
    detailedDescriptionSv: "En omfattande solsystemssimulering byggd som ett Blender-tillägg som använder Euler-approximation för att noggrant modellera planetbanor runt en sol, med anpassningsbara parametrar och visualiseringsmöjligheter.",
    features: [
    ...
    solutionSv: "Detta projekt skapades som en del av kursen TNM085 Modelleringsprojekt vid Linköpings universitet. Det visar praktisk tillämpning av fysiksimulering i en 3D-miljö, där matematisk modellering kombineras med visuell representation.",
    ...
    outcomeSv: "Systemet låter användare skapa flera planeter med unika egenskaper, visualisera deras banor och generera animationer som visar de dynamiska interaktionerna mellan himlakroppar. Koden har uppdaterats för att matcha moderna Blender Python-standarder, särskilt när det gäller implementering av shader-noder.\n\nTillägget kan installeras direkt i Blender, vilket gör det tillgängligt som ett verktyg i sidopanelen. Användare kan välja mellan standardsimulering för snabba resultat eller avancerad simulering för mer exakt banmekanik.",
  ...
  },
  {
    ...
    detailedDescriptionSv: "En modern, responsiv webbplats utvecklad för Albyrådet, en ideell ungdomsorganisation inriktad på samhällsengagemang och sociala förbättringsinitiativ i Botkyrka, Sverige. Detta pro bono-projekt ger organisationen en professionell webbnärvaro för att stödja deras samhällsarbete.",
    features: [
  ...
  },
  {
    ...
    detailedDescriptionSv: "Ett samarbetsprojekt utvecklat med ett team av 5 studenter, som skapade en modern, responsiv webbplats för Medieteknikprogrammet vid Linköpings universitet, vilket ger nuvarande och blivande studenter programinformation, nyheter och resurser.",
    features: [
    ...
    solutionSv: "Byggd med Next.js och TypeScript med Material UI som komponentbibliotek, implementerar detta projekt en mobil-först responsiv designmetod. Arkitekturen använder kontextleverantörer för enhetsdetektering och temahantering, vilket möjliggör villkorlig rendering baserad på skärmstorlek.",
...
export const timelineEvents: TimelineEvent[] = [
  {
    ...
    descriptionSv: "Avslutade min kandidatexamen med fokus på programmering och tillämpad matematik.",
    date: "2021 - 2024",
    type: "education"
  },
  {
    ...
    location: "Linköping University",
    locationSv: "Linköpings universitet",
    description: "Studying machine learning, image processing and cybersecurity in my master's program.",
    descriptionSv: "Studerar maskininlärning, bildbehandling och cybersäkerhet i mitt masterprogram.",
    date: "2024 - Present",
    type: "education"
  },
